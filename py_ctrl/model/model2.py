...
def the_model() -> Model:
    ...
    """ops[f"r1_to_pose_3"]=Operation(
                        
                        name=f"r1_to_pose_3",
                        precondition= Transition("pre",
                                                g(f"!r1_robot_run && r1_robot_state == initial && r1_robot_pose != pose_3 && r2_robot_pose != pose_3"),
                                                a(f"r1_robot_command = move_j, r1_robot_run, r1_robot_goal_frame = pose_3")),
                        postcondition=Transition("post",
                                                g(f"r1_robot_state == done"),
                                                a(f"!r1_robot_run, r1_robot_pose <-pose_3")),
                        effects= (),
                        to_run= Transition.default()
            )"""
    ...
    """
    ops[f"r2_to_pose_1"]=Operation(
                        
                        name=f"r2_to_pose_1",
                        precondition= Transition("pre",
                                                g(f"!r2_robot_run && r2_robot_state == initial && r2_robot_pose != pose_1 && r1_robot_pose != pose_1"),
                                                a(f"r2_robot_command = move_j, r2_robot_run, r2_robot_goal_frame = pose_1")),
                        postcondition=Transition("post",
                                                g(f"r2_robot_state == done"),
                                                a(f"!r2_robot_run, r2_robot_pose <-pose_1")),
                        effects= (),
                        to_run= Transition.default()
            )"""
